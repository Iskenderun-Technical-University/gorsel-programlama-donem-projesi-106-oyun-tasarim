        ...
        {
            {
                ...
                player4.Top += jumpSpeed; // refresh the player picture box consistently
                      ...
                      // and jumping is set to false
                        ...
                        { // then we do the following
                          //sonra şunu yapıyoruz
                            ...
                            player4.Top = x.Top - player4.Height;// also we place the player on top of the picture box
                ...
                if (player4.Bounds.IntersectsWith(door4.Bounds) && hasKey == true)
                {
                    ...
                    GameTimer4.Stop(); // stop the timer
