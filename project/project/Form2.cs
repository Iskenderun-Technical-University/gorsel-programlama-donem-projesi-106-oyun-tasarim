...
namespace project
{
    ...
    private void KeyIsUp(object sender, KeyEventArgs e)
        ...
        private void MainTimerEvent(object sender, EventArgs e)
        {
            ...
            player.Top += jumpSpeed;    // refresh the player picture box consistently
                ...
                if (player.Bounds.IntersectsWith(door.Bounds) && hasKey == true)
{
    ...
    GameTimer.Stop();
    MessageBox.Show("well done your " + Environment.NewLine + "clik ok to play agaın"); // show the message box
                    RestarGame();
}
